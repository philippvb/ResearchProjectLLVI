...
tau=1, lr=lr)
net.train_without_VI(train_loader, epochs=1)
feature_extractor_copy = deepcopy(feature_extractor)
...
net.train_model(train_loader, epochs=500, n_datapoints=n_datapoints, samples=5, method=LikApprox.CLOSEDFORM, approx_name="jennsen")
# net.train_ll_only(train_loader, epochs=200, n_datapoints=n_datapoints, samples=5, method=LikApprox.MONTECARLO)
# test the accuracy

net.feature_extractor = feature_extractor_copy
