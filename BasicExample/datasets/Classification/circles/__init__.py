...
def create_train_set(n_datapoints, noise=0, factor=0.1):
    x_np,y_np = datasets.make_circles(n_samples=n_datapoints, shuffle=True, noise=noise, random_state=1234, factor=factor)
